...
# (str) Package name
package.name = gdfmobile

# (str) Package domain (needed for android/ios packaging)
package.domain = org.gdf
...
requirements = python3,kivy==2.3.0,opencv-python-headless,numpy,plyer,android
...
# for documentation.
# presplash.lottie = "path/to/lottie_file.json"
...
# (list) Pattern to exclude from the result. A pattern is a 'glob' pattern
#android.whitelist =
...
# OUYA_ODK_PATH = content/ouya/odk/libs/*.jar
...
# 2) source_and_destination
# Assets to cover the root of the source directory.
#android.add_assets =
...
# (str) Python-for-Android branch to use, defaults to master, if not exists, user master
p4a.branch = master
