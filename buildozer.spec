...
# (list) Shared libraries to include
...
# (list) Android additionnal repositories
...
# (list) Java sources to add
#android.add_src =

# (list) AAR (Android Archive Resources) to add
#android.add_aars =
...
#android.add_gradle_repositories = "maven { url 'http://maven.google.com' }"

# (list) NDK build mode: one of none, system, c++_shared
#android.ndk_build_mode = system
...
# (str) python-for-android remote to use, defaults to origin
#p4a.remote = origin
...
#    org.test.mydemo, and a release version as org.test.mydemo.premium
#
#    [app]
#    package.name = mydemo
#
